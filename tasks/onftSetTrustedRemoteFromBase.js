...
module.exports = async function (taskArgs, hre) {
    ...
    const dstAddr = getDeploymentAddresses(taskArgs.targetNetwork)["VeryLongTown"]
    const exampleUniversalONFT = await ethers.getContract("VeryLongTownBase")
    console.log(`[source] VeryLongTownBase.address: ${exampleUniversalONFT.address}`)
